...
from utils.callbacks.best_epoch import BestEpochCallback

class Val_Callback(BestEpochCallback):
    def __init__(self, monitor="", mode="min"):
        super(Val_Callback, self).__init__(monitor=monitor, mode=mode)
        self.ground_truths = []
        self.predictions = []
